...
export default function SearchBar()
{
  ...
  const [listLetters, setLetters] = useState('');
  const [listCategories, setListCategories] = useState('');
  const [listCuisines, setListCuisines] = useState('');
  return (
    <>
      <div className="mx-auto max-w-7xl sm:px-6 lg:px-8 mb-4">
        <div htmlFor="query" className="block text-sm/6 font-medium text-gray-900">
          Filter all meals by:
        </div>
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center">
            <span className="bg-white px-3 text-base font-semibold text-gray-900">OR</span>
          </div>
        </div>
